...
STUDENT_PROFILES = {"BASE": (1., .1, .002), "A24R": (1., .1, .002),
                    "B20": (1., .2, .002), "E10": (1., .1, .001)}
...
def teacher_loss(model, out, gt, pan, ms, update_index, generator,
    ...
    if consistency_weight not in (1e-4, 3e-4):
        raise ValueError("Only BASE or C3 Teacher consistency is registered")
