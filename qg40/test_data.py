...
from qg40.data import (AUGMENTATION, RECIPE, QG40Dataset, _create_lp_cache, build_dataset,
                      canonical_band_indices, canonical_sha, prepare_data, sha256_file, verify_qb_msfix)
from qg40.data import verify_lp_cache
...
class DataTests(unittest.TestCase):
    ...
    def dataset(self, augment=False):
        return QG40Dataset(self.source, self.lp, spec=self.spec, split='train', augment=augment)

    def manifest(self):
        return dict(schema='QG40_DATA_v1', sensor='GF2', num_bands=4, max_pixel=1023,
