...
from qg40.reference_parity import (isolated_teacher, parity_indices,
...
class Dataset:
    ...
    def base(self, index):
        ...
        ms = torch.randn(4, 4, 4, generator=gen)
        gt = torch.full((4, 16, 16), float(index)/100)
...
class Teacher(nn.Module):
    ...
    def forward(self, pan, ms, lp):
        return {'y': self.scale * pan.repeat(1, 4, 1, 1)}
