...
from qg40.common import (ROOT, atomic_json, camp, check_deadline, object_sha,
...
def method_checks(root=ROOT):
    ...
    modules = ['qg40.test_training', 'qg40.test_evaluation', 'qg40.test_data']
...
def execute(root, server, spec_path, deadline_utc, device='cuda'):
    import torch
    from qg40.data import prepare_data, build_dataset
    from qg40.model import build_model
    from qg40.plan import SensorSpec
    ...
    if previous:
        ...
        if previous.get('complete'):
            ...
            from qg40.input_distribution import record_input_distributions
    ...
    from qg40.evaluation import FRMetrics
