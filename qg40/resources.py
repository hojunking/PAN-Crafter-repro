"""Read-only local capacity evidence for an admitted QG40 atomic block.
...
from qg40.common import camp, read_json, utcnow
from qg40.plan import FULLSTATE_STEPS, GRID_STEPS, case_for
