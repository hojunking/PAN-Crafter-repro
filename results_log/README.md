...
| 2026-08-24 | [WIP_170hx-teacher-baseline](2026-08-24_WIP_170hx-teacher-baseline.md) | **[진행 중]** 새 서버(170hx) 이식 완료 — `verify_metrics` 6지표 상대오차 0, EXP 기준선 9점 일치. `wv3_fixed_valsel` 50K 학습 중(≈5h52m). [재구성본](2026-08-24_paper-faithful-rebuild.md) 확인 이후 이 실행은 **새 기준선이 아니라 배포 코드 앵커**다. 학습 수치는 서버 간 섞지 않는다 |
