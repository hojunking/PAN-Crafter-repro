...
| 날짜 | 문서 | 요지 |
|---|---|---|
| 2026-08-25 | [paper-vs-code-divergences](2026-08-25_paper-vs-code-divergences.md) | **논문 서술 vs 배포 코드 불일치 14곳 전수 목록.** 구조 4 · 블록내부 3 · CM3A 4 · 입력 1 · 학습 1 · 보류 1. **11곳 반영으로 ERGAS 2.1643→2.1205**(−2.02%, p=0.005), 논문 격차 6.09%→3.94%. **미반영 2건** — `[K_pan|V_pan]` 결합(params 7.2122M 로 +0.59% 어긋남), 증강 crop(구현이 scale jitter). 잔차 기준선은 논문이 보간법을 안 적어 판정 보류. **full-res 는 반대로 HQNR 0.9475→0.9360** |
