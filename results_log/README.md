...
| 2026-08-26 | [WIP_dml-170hx](2026-08-26_WIP_dml-170hx.md) | **[진행 중]** Teacher–Teacher DML. M0(λ=0) 완료 — **LN+nocrop 25K 가 ERGAS 2.1098/2.1185** (GN 대비 −2.4%/−2.0%, 50K 환산 ≈2.03~2.04 = 논문 수준 후보). 단 **FR 은 악화**(HQNR −1%, 두 peer 일치) — LN 은 RR↔FR 트레이드오프. 조기 게이트 통과(오차 상관 0.9557, 오라클 +8.16% — 시드 다양성이 구조쌍보다 크다). M1(λ=0.10) 학습 중 |
