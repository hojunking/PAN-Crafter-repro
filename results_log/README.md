...
| 날짜 | 문서 | 요지 |
|---|---|---|
| 2026-08-28 | [WIP_arch-search-24h](2026-08-28_WIP_arch-search-24h.md) | **[진행 중] 24h 아키텍처 탐색 (s1, 9건).** full-res stage 완전 제거(dec_depth 옵션)·decoder 비대칭·d124 위 width 재판정(w112/w96)·9ch 유지 검증·새 초경량 구조 LR-Fuse(0.54M, 전 연산 1/16 면적). best 선택 HQNR 유지. 계획서 R2 는 A2 와 중복이라 삭제, A2·R6 꼬리 편성 |
