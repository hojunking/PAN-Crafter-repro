...
| 2026-09-02 | [WIP_teacher-arch-dual](2026-09-02_WIP_teacher-arch-dual.md) | **[진행 중] MS-only plain 의 4-6M D_λ 붕괴 발견 → dual 로 재탐색.** 1차 MS-only 탐색 7/7 완주했으나 **학습 후반 D_λ 가 0.021→0.040 으로 단조 악화**하고 손실이 용량에 비례(W96 −0.004 → W144 −0.016). 같은 구조 dual vs MS-only **plateau ΔHQNR +0.0112 로 band 초과 — dual 유의 우세**. 원인은 PAN reconstruction task 제거(γβ 무관). "MS-only 무손실" 기존 결론은 W96/W128 한정으로 축소. dual 격자 5벌 진행 중 |
