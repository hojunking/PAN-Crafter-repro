...
- 2026-09-01 06:40: **`K2_R4_uknow` 완료 (게이트 1, 2.32h).** HQNR **0.9543** @205 ·
  SCC 0.9905. 동일 teacher 대조군 K1B_T1(0.9522/0.9905)과 비교하면 HQNR 명목
...
- 2026-09-01 09:01: **`K3_R4_uknow_gtvar` 완료 (게이트 2, 2.33h) — 사다리 명목 최상.**
  HQNR **0.9552** @225 · SCC **0.9907**(사다리 최고). K2 대비 HQNR +0.0009·SCC
  +0.0002 — 판정선 미만 "구분되지 않음"이나 명목 방향은 일관 개선이고, K0(0.9562)
