...
from gfp40.anchor import ATOL, RTOL, anchor_metrics, compare_metrics, expected_anchor, verify_and_save_parent_anchor
from gfp40.common import atomic_json, object_sha, read_json
from gfp40.plan import CAMPAIGN_ID, PARENT_ASSETS, case_for
...
class AnchorTests(unittest.TestCase):
    ...
    def test_fullprecision_bundle_and_saved_comparison(self):
        ...
        self.assertEqual(source['kind'], 'DERIVED_VERIFIED_B20_REGISTRY_FULL_PRECISION')
    ...
    def test_parent_identity_and_native_protocol_guard(self):
        ...
        self.assertNotIn('P3OLD', PARENT_ASSETS['parents'])
    ...
    def test_fresh_trunk_exact_same_checkpoint(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            parent = dict(parent_id='A11', parent_kind='GFP40_FRESH_TRUNK', server='s3',
