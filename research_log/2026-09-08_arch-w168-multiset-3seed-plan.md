...
|---|---:|---:|---|---|---|
| WV3 | 8 | 2047 | O | 2025(=기존 S1_T05_W168_D123_DUAL) · 1234 · 7777 | FR lpan 복구본 |
...
큐: `config/queues/arch_w168_multiset_3seed.txt` (QB×3 → GF2×3 → WV3 1234·7777). params 5.9731M(8밴드) / 5.9610M(4밴드), smoke 통과(peak 8.6GB).

## 평가 (지표 v2)

- best 선택: 종전대로 FR H5 12-19 HQNR. 보고: 센서별 **논문 세트**(.mat 20장, `results/fr_mat20.json`) — 시트 FR 열.
